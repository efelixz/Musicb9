    ...
    <div className="flex flex-col h-[calc(100vh-64px)] bg-[#0f172a]">
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-96 bg-[#111827] border-l border-slate-800 flex flex-col p-8 overflow-y-auto">
            <div className="mb-10">
                <h3 className="text-white font-bold uppercase tracking-widest text-[10px] mb-4">Vozes no Projeto</h3>
                <div className="flex gap-2">
                    <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-xs font-bold text-white border-2 border-slate-800">R</div>
                    <div className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-xs font-bold text-slate-500 border-2 border-blue-500/50 cursor-pointer hover:bg-slate-700 transition">+</div>
                </div>
                <p className="text-[10px] text-slate-500 mt-2 italic">Adicione uma voz do marketplace para um dueto.</p>
            </div>
